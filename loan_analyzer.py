...
print(f"Sum of loans is {sum_of_loans}")


# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
avg_loan_amount=sum_of_loans/number_of_loans
print(f"Average loan amount is {avg_loan_amount}")
...
loan_value = loan.get("loan_price")

if present_value >= loan_value:
...
output_path = Path("C:\Madhumita\Starter_Code\Starter_Code\inexpensive_loans.csv")
